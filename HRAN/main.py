...
def main():
    ...
    parser.add_argument('--model_name', type=str, default="HRAN", help='HRAN')
    ...
    parser.add_argument('--hidden_dropout', type=float, default=0.4, help='hidden dropout')
    ...
    run = RunModel(data, modelname=args.model_name, optimizer_method=args.optimizer_method,
                   ...
                   alpha=args.self_weight, regular_method="", regular_rate=1e-6)
    run.train_and_eval()
